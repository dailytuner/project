...
# Для начала используем старый HTML, потом перейдем на Jinja2
# Создадим функцию, которая возвращает HTML из web_api

# Временно храним HTML здесь, потом перенесем в шаблоны
INDEX_HTML = """
<!DOCTYPE html>
<html lang="ru">
<head>
